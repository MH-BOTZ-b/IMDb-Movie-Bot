...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Channel", url="https://t.me/Moviezz_ClubTG"),
                InlineKeyboardButton(" Group ⭕️", url="https://t.me/Moviez_ClubTG")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/+70wnIr3wqXw1Yzll'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/f_search_updates')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/moviez_Clubtg')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/f_search_updates'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/moviez_Clubtg')
            ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Grouo', url='https://t.me/moviez_Clubtg')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Updates', url='https://t.me/f_search_updates'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ JOIN UPDATES CHANNEL ⭕️",url="https://t.me/F_SEARCH_UPDATES")
    ])
